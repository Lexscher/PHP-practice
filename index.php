    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <!-- Preview Image -->
          <img class="img-fluid rounded" src="https://static.tripping.com/uploads/image/0/3180/best-places-to-catch-pokemon-asia_hero.jpg" alt="">

          <hr>

          <!-- Post Content -->
          <p class="lead"><?php echo $school_description ?></p>
          ...
          <div class="media mb-4">
            ...
            <div class="media-body">
              <h5 class="mt-0"><?php rando($cool_peeps); ?></h5>
              ...
              <div class="row">
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    <li>
                      <a class="card-link" href="#">Web Design</a>
                    </li>
                    <li>
                      <a class="card-link" href="#">HTML</a>
                    </li>
                    <li>
                      <a class="card-link" href="#">Freebies</a>
                    </li>
                  </ul>
                </div>
                <div class="col-lg-6">
                  <ul class="list-unstyled mb-0">
                    ...
                    <li>
                      <a class="card-link" href="#">Tutorials</a>
                    </li>
                  </ul>
                </div>
              </div>
